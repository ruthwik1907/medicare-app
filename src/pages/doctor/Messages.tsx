  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-slate-500 text-sm mt-1">Communicate directly with your patients and colleagues.</p>
      </div>
          ...
          {activeConversation ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-slate-500 max-w-sm">
                Select a conversation from the sidebar to view messages or start a new conversation with your patients or colleagues.
              </p>
            </div>
          )}
        </div>
